...
import '../../../settings/constant/settings_constant.dart';
...
class _WeatherWidgetState extends State<WeatherWidget> {
  ...
  void initState() {
    super.initState();
    unit = unitBox.get('unit', defaultValue: Unit.metric) ?? Unit.metric;
    scaleIsDegree.value = box.get('scaleIsDegree', defaultValue: true) ?? true;
  }
